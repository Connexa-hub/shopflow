...
# inventory-service).
os.environ.setdefault("SERVICE_NAME", "sales-service")
os.environ.setdefault("DATABASE_URL", "sqlite+aiosqlite:///:memory:")
os.environ.setdefault("REDIS_URL", "redis://localhost:6379/0")
os.environ.setdefault("JWT_SECRET_KEY", "test-secret-key-for-pytest-only-do-not-use-in-prod")
os.environ.setdefault("ENVIRONMENT", "test")
os.environ.setdefault("INVENTORY_SERVICE_URL", "http://inventory-service-not-used-in-tests:8000")
...
from app.core.dependencies import get_inventory_client  # noqa: E402
from app.domain.base import Base  # noqa: E402
from app.main import app  # noqa: E402
from tests.fakes import FakeInventoryClient  # noqa: E402
...
@pytest_asyncio.fixture
async def client(db_session, fake_inventory):
    async def _override_get_db_session():
        yield db_session

    def _override_get_inventory_client():
        return fake_inventory

    app.dependency_overrides[get_db_session] = _override_get_db_session
    app.dependency_overrides[get_inventory_client] = _override_get_inventory_client
...
@pytest_asyncio.fixture
def manager_headers(business_id):
    token = make_access_token(business_id=business_id, role=Role.MANAGER)
    return {"Authorization": f"Bearer {token}"}
