...
sales-service is the one consumer that actually uses `Principal.raw_token`
(forwarded to inventory-service — see app/core/inventory_client.py) rather
than ignoring it; every Principal now carries it uniformly regardless of
service, which is simpler than making it conditional.
"""
import uuid
